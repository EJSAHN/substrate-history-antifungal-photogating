...
**JMP-derived variable clustering note.** Variable clustering was performed in JMP Pro 17 and is reported in Supplementary Table S2. This JMP-derived summary is not regenerated by the Python no-figure pipeline and is therefore not included as a worksheet in Supplementary Data 1. The Python pipeline generates the morphology bootstrap summaries, dose-response tables, circularity summaries, Levene tests, and HSI tables used for the workbook.
